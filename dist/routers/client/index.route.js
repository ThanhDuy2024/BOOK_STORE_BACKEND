...
const tracking_route_1 = __importDefault(require("./tracking.route"));
const contacts_route_1 = __importDefault(require("./contacts.route"));
...
route.use("/tracking", tracking_route_1.default);
route.use("/contacts", contacts_route_1.default);
